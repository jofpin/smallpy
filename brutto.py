...
# Character numbers and letters for the brute force process
...
def main():
    ...
    print "\t\t---------------" + color['green'] + "brutto" + color['white'] + "-------------"
    ...
    # nice with itertools process
    for password in itertools.imap("".join, itertools.product(characters, repeat = valuePass)):
